...
**Navbar:** A responsive Bootstrap navbar is used on all pages. It includes a collapsible mobile menu (`navbar-expand-lg`, `navbar-toggler`, and `collapse`), functions correctly on smaller screens.

**Card:** A Bootstrap card component used on `hobbies.html` page.

**Button:** A Bootstrap button (`btn btn-primary`) is used within the card on the `hobbies.html` page to link to my portfolio.
